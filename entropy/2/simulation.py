# run this script on cluster/AWS/etc. to compute Gamma-minimax estimator
...
b_ub = np.array([-.95, 5., -4.])
prior_credible_range = torch.tensor([3.5, 5.5])
...
Gamma_minimax_Risk = simulation_object.calc_Risks_tensor(n_sample=2000, distributions=(p,)).item()
JVHW_Risk = simulation_object.calc_Risks_tensor(n_sample=2000, estimator=JVHW_estimator(), distributions=(p,)).item()
