...
class Gamma_minimax_Problem(object):
    ...
    def __init__(self, estimator, parameter_constraint_fun, b_ub=None, b_eq=None, Risk_fun=lambda estimates, true_parameters: torch.sum((estimates - true_parameters)**2, dim=2).mean(dim=1), p_init=None, n_distr=1000, init_prior_prob=None, MCMC_MC_size=100, parameter=None):
    ...
    def enlarge_distr_grid(self, n_distr=500):
